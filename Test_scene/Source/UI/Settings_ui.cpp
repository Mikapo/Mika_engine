...
void Settings_ui::setup_camera_settings(UI_window* window)
{
    ...
    auto camera_max_clip_slide =
        camera_settings->create_children_cast<Float_slider>(Float_slider::static_class(), "Max clip", 0);
    ...
    auto* camera_min_clip_slide =
        camera_settings->create_children_cast<Float_slider>(Float_slider::static_class(), "Min clip", 1);
    ...
    auto* camera_fov_slide =
        camera_settings->create_children_cast<Float_slider>(Float_slider::static_class(), "Fov", 2);
...
void Settings_ui::setup_light_settings(UI_window* window)
{
    ...
    auto* light_angle_slide =
        light_settings->create_children_cast<Float_slider>(Float_slider::static_class(), "Angle", 1);
    light_angle_slide->m_on_slider_change.add_object(this, &Settings_ui::change_light_angle);

    auto* light_color_picker =
        light_settings->create_children_cast<Color_picker>(Color_picker::static_class(), "Color", 0);
...
void Settings_ui::setup_render_settings(UI_window* window)
{
    ...
    auto* ambient_enabled_checkbox =
        render_settings->create_children_cast<Checkbox>(Checkbox::static_class(), "Ambient", 1);
    ...
    auto* diffuse_enabled_checkbox =
        render_settings->create_children_cast<Checkbox>(Checkbox::static_class(), "Diffuse", 2);
    ...
    auto* specular_enabled_checkbox =
        render_settings->create_children_cast<Checkbox>(Checkbox::static_class(), "Specular", 3);
    ...
    auto* shadow_enabled_checkbox =
        render_settings->create_children_cast<Checkbox>(Checkbox::static_class(), "Shadow", 4);
    ...
    auto* texture_enabled_checkbox =
        render_settings->create_children_cast<Checkbox>(Checkbox::static_class(), "Texture", 5);
