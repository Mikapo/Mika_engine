...
namespace glm
{
    ...
    /// @see <a href="https://www.khronos.org/registry/OpenGL-Refpages/gl2.1/xhtml/gluOrtho2D.xml">gluOrtho2D man
    /// page</a>
    template <typename T>
    GLM_FUNC_DECL mat<4, 4, T, defaultp> ortho(T left, T right, T bottom, T top);

    /// Creates a matrix for an orthographic parallel viewing volume, using left-handed coordinates.
    /// The near and far clip planes correspond to z normalized device coordinates of 0 and +1 respectively. (Direct3D
    ...
    /// The near and far clip planes correspond to z normalized device coordinates of -1 and +1 respectively. (OpenGL
    /// clip volume definition)
    ///
    /// @tparam T A floating-point scalar type
    ///
    ...
    /// Creates a matrix for an orthographic parallel viewing volume, using left-handed coordinates if
    /// GLM_FORCE_LEFT_HANDED if defined or right-handed coordinates otherwise. The near and far clip planes correspond
    /// to z normalized device coordinates of -1 and +1 respectively. (OpenGL clip volume definition)
    ///
    /// @tparam T A floating-point scalar type
    ///
    /// @see - glm::ortho(T const& left, T const& right, T const& bottom, T const& top)
    ...
    /// Creates a matrix for an orthographic parallel viewing volume, using the default handedness and default near and
    /// far clip planes definition. To change default handedness use GLM_FORCE_LEFT_HANDED. To change default near and
    /// far clip planes definition use GLM_FORCE_DEPTH_ZERO_TO_ONE.
    ///
    /// @tparam T A floating-point scalar type
    ///
    /// @see - glm::ortho(T const& left, T const& right, T const& bottom, T const& top)
    ...
    /// Creates a frustum matrix with default handedness, using the default handedness and default near and far clip
    /// planes definition. To change default handedness use GLM_FORCE_LEFT_HANDED. To change default near and far clip
    ...
    /// Creates a matrix for a symetric perspective-view frustum using left-handed coordinates if GLM_FORCE_LEFT_HANDED
    ...
    /// Creates a matrix for a symetric perspective-view frustum based on the default handedness and default near and
    /// far clip planes definition. To change default handedness use GLM_FORCE_LEFT_HANDED. To change default near and
    /// far clip planes definition use GLM_FORCE_DEPTH_ZERO_TO_ONE.
    ///
    ...
    ///
    /// @tparam T A floating-point scalar type
    /// @see <a href="https://www.khronos.org/registry/OpenGL-Refpages/gl2.1/xhtml/gluPerspective.xml">gluPerspective
    /// man page</a>
    template <typename T>
    ...
    /// Builds a perspective projection matrix based on a field of view and the default handedness and default near and
    /// far clip planes definition. To change default handedness use GLM_FORCE_LEFT_HANDED. To change default near and
    /// far clip planes definition use GLM_FORCE_DEPTH_ZERO_TO_ONE.
    ///
    /// @param fov Expressed in radians.
