    ...
    for (int n = 0; n < platform_io.Viewports.Size; n++)
    {
        ...
        if (is_window_focused)
        {
            ...
            if (io.WantSetMousePos)
                glfwSetCursorPos(
                    window, (double)(mouse_pos_prev.x - viewport->Pos.x), (double)(mouse_pos_prev.y - viewport->Pos.y));
...
static void ImGui_ImplGlfw_UpdateMouseCursor()
{
    ...
    for (int n = 0; n < platform_io.Viewports.Size; n++)
    {
        ...
        else
        {
            ...
            // here.
            glfwSetCursor(
                window, bd->MouseCursors[imgui_cursor] ? bd->MouseCursors[imgui_cursor]
...
static int ImGui_ImplGlfw_CreateVkSurface(
    ImGuiViewport* viewport, ImU64 vk_instance, const void* vk_allocator, ImU64* out_vk_surface)
{
    ...
    VkResult err = glfwCreateWindowSurface(
        (VkInstance)vk_instance, vd->Window, (const VkAllocationCallbacks*)vk_allocator, (VkSurfaceKHR*)out_vk_surface);
    return (int)err;
}
