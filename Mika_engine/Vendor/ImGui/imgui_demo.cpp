...
static void ShowDemoWindowWidgets()
{
    ...
    if (ImGui::TreeNode("Color/Picker Widgets"))
    {
        ...
        if (ImGui::BeginPopup("mypicker"))
        {
            ...
            ImGui::Text("Current");
            ImGui::ColorButton(
                "##current", color, ImGuiColorEditFlags_NoPicker | ImGuiColorEditFlags_AlphaPreviewHalf,
                ImVec2(60, 40));
            ImGui::Text("Previous");
        ...
        ImGui::ColorButton(
            "MyColor##3c", *(ImVec4*)&color, misc_flags | (no_border ? ImGuiColorEditFlags_NoBorder : 0),
            ImVec2(80, 80));
...
static void ShowDemoWindowTables()
{
    ...
    if (ImGui::TreeNode("Reorderable, hideable, with headers"))
    {
        ...
        ImGui::SameLine();
        HelpMarker("Disable vertical borders in columns Body until hovered for resize (borders will always appears in "
                   "Headers)");
        PopStyleCompact();
    ...
    if (ImGui::TreeNode("Horizontal scrolling"))
    {
        ...
        if (ImGui::BeginTable("table_scrollx", 7, flags, outer_size))
        {
            ...
            ImGui::TableSetupColumn(
                "Line #", ImGuiTableColumnFlags_NoHide); // Make the first column not hideable to match our use of
    ...
    if (ImGui::TreeNode("Advanced"))
    {
        ...
        if (ImGui::TreeNode("Options"))
        {
            ...
            if (ImGui::TreeNodeEx("Other:", ImGuiTreeNodeFlags_DefaultOpen))
            {
                ...
                ImGui::Combo(
                    "items_type (first column)", &contents_type, contents_type_names,
    ...
    if (ImGui::CollapsingHeader("Inputs, Navigation & Focus"))
    {
        ...
        if (ImGui::TreeNode("Keyboard, Gamepad & Navigation State"))
        {
            ...
            // Draw an arbitrary US keyboard layout to visualize translated keys
            {
                ...
                ImVec2 board_max = ImVec2(
                    board_min.x + 3 * key_step.x + 2 * key_row_offset + 10.0f, board_min.y + 3 * key_step.y + 10.0f);
                ...
                for (int n = 0; n < IM_ARRAYSIZE(keys_to_display); n++)
                {
                    ...
                    draw_list->AddRect(
                        face_min, face_max, IM_COL32(193, 193, 193, 255), key_face_rounding, ImDrawFlags_None, 2.0f);
...
struct MyDocument
{
    ...
    static void DisplayContents(MyDocument* doc)
    {
        ...
        if (ImGui::Button("Save", ImVec2(100, 0)))
            doc->DoSave();
        ImGui::ColorEdit3(
            "color", &doc->Color.x); // Useful to test drag and drop and hold-dragged-to-open-tab behavior.
        ImGui::PopID();
    }
